...
<body>
  ...
  <div class="login-container">
    ...
    <form method="post" class="space-y-4">
      ...
      <div class="relative">
        <input type="password" id="login-password" name="password" placeholder="Password" required class="input-field pr-16">
        <button type="button" onclick="togglePassword('login-password', this)" class="show-btn">Show</button>
      </div>

      <button type="submit" class="ocean-btn">Login</button>
    </form>

    <p class="text-center text-sm text-gray-600 mt-4">
      Don't have an account?  
      <a href="<?= site_url('/') ?>" class="link">Register</a>
    </p>
  </div>
